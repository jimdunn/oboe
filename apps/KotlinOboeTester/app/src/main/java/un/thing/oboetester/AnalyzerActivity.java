...
public class AnalyzerActivity extends TestInputActivity {
    ...
    protected void resetConfiguration() {
        ...
        if (streamContext != null) {
            if (streamContext.getConfigurationView() != null) {
                streamContext.getConfigurationView().setFormat(StreamConfiguration.AUDIO_FORMAT_PCM_FLOAT);
                streamContext.getConfigurationView().setFormatConversionAllowed(true);
            }
        }
