...
public class RoundTripLatencyActivity extends AnalyzerActivity {
    ...
    public void startTestUsingBundle() {
        try {
            ...
            mBufferBursts = getMBundleFromIntent().getInt(IntentBasedTestSupport.KEY_BUFFER_BURSTS, mBufferBursts);

            onMeasure(null);
        } finally {
            setMBundleFromIntent(null);
