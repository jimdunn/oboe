...
public class DeviceReportActivity extends Activity {
    ...
    private void reportDeviceInfo(Collection<AudioDeviceInfo> devices) {
        ...
        report.append("App: ").append(MainActivity.Companion.getVersionText()).append("\n");
    ...
    private String reportExtraDeviceInfo() {
        ...
        report.append("\n\n############################");
        report.append("\nAudioManager:");
        report.append(AudioQueryTools.INSTANCE.getAudioManagerReport(mAudioManager));
        report.append("\n\nFeatures:");
        report.append(AudioQueryTools.INSTANCE.getAudioFeatureReport(getPackageManager()));
        report.append(AudioQueryTools.INSTANCE.getMediaPerformanceClass());
        report.append("\n\nProperties:");
        report.append(AudioQueryTools.INSTANCE.getAudioPropertyReport());
        return report.toString();
    }
