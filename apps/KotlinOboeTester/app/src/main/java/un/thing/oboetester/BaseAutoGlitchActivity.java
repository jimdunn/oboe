...
public class BaseAutoGlitchActivity extends GlitchActivity {
    ...
    void logDeviceInfo() {
        ...
        log(AudioQueryTools.INSTANCE.getAudioManagerReport(audioManager));
        log(AudioQueryTools.INSTANCE.getAudioFeatureReport(getPackageManager()));
        log(AudioQueryTools.INSTANCE.getAudioPropertyReport());
        log("\n############################");
    }
