...
import un.thing.audio_device.AudioDeviceListEntry;
import un.thing.audio_device.AudioDeviceSpinner;
...
public class StreamConfigurationView extends LinearLayout {
    ...
    private void initializeViews(Context context) {
        ...
        boolean mmapSupported = NativeEngine.INSTANCE.isMMapSupported();// isMMapSupported();
        ...
        boolean mmapExclusiveSupported = NativeEngine.INSTANCE.isMMapExclusiveSupported();
    ...
    public void setChildrenEnabled(boolean enabled) {
        ...
        mRequestedMMapView.setEnabled(enabled && NativeEngine.INSTANCE.isMMapSupported());
        mRequestedExclusiveView.setEnabled(enabled && NativeEngine.INSTANCE.isMMapExclusiveSupported());
